...
describe('DeploymentBucketPlugin', () => {
  ...
  describe('constructor', () => {
    beforeEach(() => {
      plugin = new DeploymentBucketPlugin(serverless, options, { log: logMock })
    })
  ...
  describe('applyDeploymentBucket()', () => {
    ...
    it('should log info when using existing deployment bucket', async () => {
      ...
      expect(logSpy).toHaveBeenCalledWith(expect.stringContaining('Using deployment bucket'))
    })

    it('should log info when creating a new deployment bucket', async () => {
      plugin.provider.request.mockRejectedValueOnce({}) // S3.headBucket()

      await plugin.applyDeploymentBucket()

      expect(logSpy).toHaveBeenCalledWith(expect.stringContaining('Creating deployment bucket'))
    })

    it('should log info when using a cross account deployment bucket', async () => {
      plugin.provider.request.mockRejectedValueOnce({ code: 'AWS_S3_HEAD_BUCKET_FORBIDDEN' }) // S3.headBucket()

      await plugin.applyDeploymentBucket()

      expect(logSpy).toHaveBeenCalledWith(expect.stringContaining('Cross account bucket is being used'))
    })
    ...
    it('should log info when SSE is applied to deployment bucket', async () => {
      ...
      expect(logSpy).toHaveBeenCalledWith(expect.stringContaining('Applied SSE'))
    })
    ...
    it('should log info when versioning is applied to deployment bucket', async () => {
      ...
      expect(logSpy).toHaveBeenCalledWith(expect.stringContaining('Enabled versioning'))
    })
    ...
    it('should suspend versioning when versioning is not already suspended on deployment bucket', async () => {
      ...
      expect(logSpy).toHaveBeenCalledWith(expect.stringContaining('Suspended versioning'))
    })
    ...
    it('should log info when acceleration is applied to deployment bucket', async () => {
      ...
      expect(logSpy).toHaveBeenCalledWith(expect.stringContaining('Enabled acceleration'))
    })
    ...
    it('should suspend acceleration when acceleration is not already suspended on deployment bucket', async () => {
      ...
      expect(logSpy).toHaveBeenCalledWith(expect.stringContaining('Suspended acceleration'))
    })
    ...
    it('should log error when exception caught', async () => {
      ...
      expect(logSpy).toHaveBeenLastCalledWith(expect.any(String), errorMessage);
    })
    ...
    it('should not enable versioning when versioning is already enabled on deployment bucket', async () => {
      ...
      expect(logSpy).not.toHaveBeenCalledWith(expect.stringContaining('Enabled versioning'))
    })
    ...
    it('should not enable acceleration when acceleration is already enabled on deployment bucket', async () => {
      ...
      expect(logSpy).not.toHaveBeenCalledWith(expect.stringContaining('Enabled acceleration'))
    })
    ...
    it('should apply SSE (AES256) if configured on provider', async () => {
      ...
      expect(logSpy).toHaveBeenCalledWith(expect.stringContaining('Applied SSE (AES256)'))
    })
    ...
    it('should apply SSE (KMS) if configured on provider', async () => {
      ...
      expect(logSpy).toHaveBeenCalledWith(expect.stringContaining('Applied SSE (aws:kms)'))
    })
    ...
    it('should not apply SSE if not configured on provider', async () => {
      ...
      expect(logSpy).not.toHaveBeenCalledWith(expect.stringContaining('Applied SSE'))
    })
    ...
    it('should not apply bucket policy if not configured', async () => {
      ...
      expect(logSpy).not.toHaveBeenCalledWith(expect.stringContaining('Applied deployment bucket policy'))
    })
    ...
    it('should apply bucket policy if configured', async () => {
      ...
      expect(logSpy).toHaveBeenCalledWith(expect.stringContaining('Applied deployment bucket policy'))
    })

    it('should not apply bucket policy if cross account', async () => {
      plugin.config.policy = '{}'
      plugin.provider.request
        .mockRejectedValueOnce({ code: 'AWS_S3_HEAD_BUCKET_FORBIDDEN' }) // S3.headBucket()
        .mockResolvedValueOnce({}) // S3.getBucketEncryption()

      await plugin.applyDeploymentBucket()

      expect(logSpy).toHaveBeenCalledWith(expect.stringContaining('Skipping bucket policy because bucket is cross account'))
    })
    ...
    it('should not apply bucket tags if not configured and getBucketTagging() throws exception', async () => {
      ...
      expect(logSpy).not.toHaveBeenCalledWith(expect.stringContaining('Updated deployment bucket tags'))
    })
    ...
    it('should apply bucket tags if configured', async () => {
      ...
      expect(logSpy).toHaveBeenCalledWith(expect.stringContaining('Updated deployment bucket tags'))
    })
    ...
    it('should not apply bucket public access block if not configured and getPublicAccessBlock() throws exception', async () => {
      ...
      expect(logSpy).not.toHaveBeenCalledWith(expect.stringContaining('Updated deployment bucket public access block'))
    })
    ...
    it('should apply bucket public access block if configured', async () => {
      ...
      expect(logSpy).toHaveBeenCalledWith(expect.stringContaining('Updated deployment bucket public access block'))
    })
    ...
    it('should log info about addition when access logging is applied to deployment bucket', async () => {
      ...
      expect(logSpy).toHaveBeenCalledWith(expect.stringContaining('Enabled access logging on deployment bucket'))
    })
    ...
    it('should log info about removal when access logging is applied to deployment bucket', async () => {
      ...
      expect(logSpy).toHaveBeenCalledWith(expect.stringContaining('Suspended access logging on deployment bucket'))
    })
  })
})
