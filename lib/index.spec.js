...
describe('DeploymentBucketPlugin', () => {
  ...
  describe('applyDeploymentBucket()', () => {
    ...
    it('should log info when using a cross account deployment bucket', async () => {
      ...
      expect(plugin.serverless.cli.log).toHaveBeenCalledWith(expect.stringContaining('Cross account bucket is being used'))
    })
    ...
    it('should not apply bucket policy if cross account', async () => {
      ...
      expect(plugin.serverless.cli.log).toHaveBeenCalledWith(expect.stringContaining('Skipping bucket policy because bucket is cross account'))
    })
